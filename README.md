...
|   ID   |  Assunto  |    Iteração    |    Fonte do requisito    |    Última atualização    |    Responsáveis    |
| :---         |     :---:      |     :---:      |     :---:      |     :---:      |          ---: |
| E1     | Implementação da interface do cadastro de discente.     | 1   | RF01    | 22/10/2019    | git status    |
| E2     | Configuração do projeto no GitHub.       | 1      | RNF07    | 28/10/2019    | git status    |
| E3     | Projeto da aplicação em Flutter.       | 1      | RNF04    | 28/10/2019    | git status    |
| E4     | Projeto da API em TypeScript.       | 1      | RNF03, RNF05    | 28/10/2019    | git status    |
| E5     | Configuração do Travis CI para API.       | 1      | RNF08    | 28/10/2019    | git status    |
| E6     | Design do Banco de Dados.       | 1      | RNF06    | 28/10/2019    | git status    |
| E7     | Implementação da validação de cadastro pelo SIGAA.       | RF01      | 25/11/2019    | git status    |
| E8     | Módulo para reportar avaliação.       | 2      | RF02    | 25/11/2019    | git status    |
| E9     | Módulo preenchimento de avaliação.       | 2      | RF05, RF07    | 25/11/2019    | git status    |
